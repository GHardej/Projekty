...
const swapSelected = () => {
  const currencyOneSelectedIndex = currencyOne.selectedIndex;
  currencyOne.selectedIndex = currencyTwo.selectedIndex;
  currencyTwo.selectedIndex = currencyOneSelectedIndex;
  calculate();
};
